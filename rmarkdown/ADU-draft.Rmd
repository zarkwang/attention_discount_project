...
**Axiom 1**: For any reward sequence $X_T$, $X'_T$, $X''_T$ and real
number $\alpha\in(0,1)$, $X_T\succ X'_T$ implies
...
reward sequence $S_T$, let $cS_T$ denote $[c,s_0,s_1,...,s_T]$, then
$c\sim S_T$ implies $S_T \sim cS_T$.
