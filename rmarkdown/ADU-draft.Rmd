...
**Axiom 2**: For any non-negative real number $c$ and reward sequence
$X_T$, let $cX_T$ denote $[c,x_0,x_1,...,x_T]$, then $c\sim X_T$ implies
$X_T \sim cX_T$.
...
there exist $c$ and $X_T$ such that, for any $c'$ and $X_T'$,
$cX_T\succsim c'X_T'$, where $c+\sum_{t=0}^Tx_t=c'+\sum_{t=0}^Tx_t'$,
then for any $X'_T$, we have
$$X_T \succsim X_T' \Longleftrightarrow c\sim X_T$$where
