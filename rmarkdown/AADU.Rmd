...
**Proposition 5**: Suppose $t\geq1$, $v'(x)$ is finite and
$-\frac{v''(x)}{v'(x)^2}<2$ at $x=0$, then there exists a threshold
$x^*$ in $(0,+\infty)$ such that $V(x,t)$ is convex in $x$ when
$x\leq x^*$ and concave in $x$ when $x>x^*$.
